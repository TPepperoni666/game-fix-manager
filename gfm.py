    ...
    def menu_settings(self):
        ...
        while True:
            ...
            choice = self.ui.choose("Setup & maintenance:", [
                ...
                "📅 Weekly Backup Timer (runs the whole backup by itself, Sundays 7pm)",
    ...
    def menu_advanced(self):
        ...
        while True:
            ...
            choice = self.ui.choose("Run which step?", [
                ...
                "🎨 Capture One Game (copy its artwork + save files into the store)",
                "💼 Back Up Prefixes (pick games — copy their Proton prefixes to the SD)",
                "🔁 Back Up Prefixes Now (repeat the last selection — no picker)",
                "📥 Import Prefix Backups (copy prefixes from the SD back into Steam)",
